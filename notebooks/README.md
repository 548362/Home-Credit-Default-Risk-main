...
| 04.1 | `04.1_experiment_binning_comparison.ipynb` | Optional supervised OptimalBinning vs equal-frequency binning experiment | Comparison metrics and plots |
...
| 08 | `08_validation.ipynb` | KS plot, PSI, Gini/Lorenz curve, calibration — stratified holdout validation | — |
| 09 | `09_strategy_cutoff_analysis.ipynb` | Cutoff, approval rate, bad rate, pricing and ROI analysis | `models/tradeoff_3strategies.png` `models/pricing_comparison.png` |
| 10 | `10_final_summary.ipynb` | Model comparison dashboard, final conclusions | `models/final_dashboard.png` |
...
- The default validation split is stratified random holdout (`test_size=0.2`, `random_state=42`), not a true time-based OOT split.
